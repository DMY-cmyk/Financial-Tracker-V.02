...
const layoutSrc = readFileSync(resolve('src/app/layout.tsx'), 'utf-8');

describe('Root layout renders SkipLink', () => {
  it('mounts <SkipLink /> in the root layout', () => {
    expect(layoutSrc).toContain('<SkipLink');
  });
});
